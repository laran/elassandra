# -*- coding: utf-8 -*-
#
# Elassandra documentation build configuration file, created by
...
.. |tgz_url| replace:: {tgz_url}
.. |rpm_url| replace:: {rpm_url}
.. |deb_url| replace:: {deb_url}
""".format(version=version, release=release, tgz_url=tgz_url, deb_url=deb_url, rpm_url=rpm_url)
...
#html_title = u'Elassandra v10'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = u'Elassandra'
...
htmlhelp_basename = 'Elassandradoc'
...
man_pages = [
    (master_doc, 'elassandra', u'Elassandra Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Elassandra', u'Elassandra Documentation',
     author, 'Elassandra', 'One line description of project.',
     'Miscellaneous'),
]
